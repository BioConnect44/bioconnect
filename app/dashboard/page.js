    ...
    <div>
      ...
      >
        <div>
          ...
          >
            Welcome Back, {profile?.full_name?.split(" ")[0] || "Name"}!
          </h1>
          <p
            style={{ fontSize: "16px", color: "#6B8A9A", marginBottom: "24px" }}
          >
      ...
      >
        ...
        >
          ...
          {[
            {
              title: "EcoRI Enzyme Guide",
              time: "2-mark summary uploaded • 1h ago",
            },
            {
              title: "Protein Purification",
              time: "5-mark detailed notes • 3h ago",
            },
            {
              title: "Microbial Growth Curves",
              time: "One-paragraph revision • 1d ago",
            },
          ].map((u, i) => (
            <div
              key={i}
            ...
            >
              ...
              <div>
                ...
                <p style={{ fontSize: "12px", color: "#9CA3AF" }}>{u.time}</p>
              </div>
            </div>
          ))}
        </div>
          ...
          {[
            {
              month: "AUG",
              day: "14",
              title: "Annual Biotech Symposium",
            ...
            },
            {
              ...
              loc: "Group-stage format (36 Teams)",
            },
            {
              month: "SEP",
              day: "12",
              title: "Lab Skills Workshop",
              loc: "Registration closes tomorrow",
              urgent: true,
            },
          ].map((ev, i) => (
            <div
              ...
              style={{
                display: "flex",
                gap: "16px",
                padding: ev.isFirst ? "12px" : "0",
                background: ev.isFirst ? "#E0F2FE" : "transparent",
                borderRadius: "12px",
                marginBottom: ev.isFirst ? "16px" : "20px",
                marginLeft: ev.isFirst ? "-12px" : "0",
                marginRight: ev.isFirst ? "-12px" : "0",
              }}
            >
              <div
                style={{
                  width: 44,
                  height: 44,
                  background: ev.isFirst ? "#fff" : "#E0F2FE",
                  borderRadius: "12px",
                  display: "flex",
      ...
      >
        ...
        >
          <div>
            ...
            >
              What type of DNA overhang is produced by the EcoRI restriction
              enzyme?
            </p>
...
function EducatorDashboard({ profile }) {
  ...
  return (
    <div>
      <div
        style={{
          background: "linear-gradient(135deg, #F0FDF9 0%, #E8F9F5 100%)",
          borderRadius: "20px",
          padding: "32px 40px",
          display: "flex",
          justifyContent: "space-between",
      ...
      >
        <div style={{ position: "relative", zIndex: 2 }}>
          ...
          <p
            style={{ fontSize: "14px", color: "#6B8A9A", marginBottom: "20px" }}
          >
            You have 24 new submissions to grade across 3 active courses.
          </p>
          <a
            href="/profile"
            style={{
...
function ResearcherDashboard({ profile, supabase }) {
  ...
  return (
    <div>
      <div
        style={{
          background: "linear-gradient(135deg, #F0FDF9 0%, #EBF9F6 100%)",
          borderRadius: "20px",
          padding: "32px 40px",
          display: "flex",
          justifyContent: "space-between",
      ...
      >
        <div style={{ position: "relative", zIndex: 2 }}>
          ...
          <p
            style={{ fontSize: "14px", color: "#6B8A9A", marginBottom: "20px" }}
          >
            Continue your Research Journey here
          </p>
          <a
            href="/profile"
            style={{
        ...
        >
          <img
            src="/researcher-illustration.png"
