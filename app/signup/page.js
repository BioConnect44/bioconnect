        ...
        <div className="auth-form-panel">
          ...
          <form onSubmit={handleSubmit} style={{ display: "flex", flexDirection: "column", gap: "13px", width: "100%" }}>
            ...
            <div style={{ position: "relative" }}>
              <input value={form.password} onChange={e => setForm({...form, password: e.target.value})} type={showPw ? "text" : "password"} placeholder="Password" required minLength={8} style={{ ...S.input, paddingRight: "65px" }}/>
              <button
                type="button"
                onClick={(e) => {
                  e.preventDefault();
